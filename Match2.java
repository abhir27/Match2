...
public class Match2 extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(conf,new Match2(), args);
        System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
       ...
       line=Integer.toString(0);
		...
		//Sort edges
		        ...
		        job.setJarByClass(Match2.class);
		...
		//divide in partitions
		      ...
		      //  job1.setReducerClass(SampleReducer.class);
		        ...
		        job1.setJarByClass(Match2.class);
		        ...
		        FileInputFormat.setInputPaths(job2, new Path(args[1]+"b"+it));
		        FileOutputFormat.setOutputPath(job2, new Path(args[1]+"c"+it));
		        job2.setJarByClass(Match2.class);
